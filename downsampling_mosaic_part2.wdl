...
workflow downSampling_02 {
  ...
  input {
    ...
    Boolean run_markdup = false
    Boolean run_count_coverage = true
    Boolean run_collect_counts = false
  ...
  #################################################################################
  ####        combines two sets of downsampled FASTQ files, and randomly sorts    #
  #################################################################################
  call combineAndRandomSort{
    input : 
      ...
      runtime_attr_override = runtime_attr_combine_random_sort
  ...
  call realign {
    input :
      downsample_file_1 = combineAndRandomSort.randomized_fastq_1_file,
      downsample_file_2 = combineAndRandomSort.randomized_fastq_2_file,
  ...
  call sortIndex {
    input :
      cram_downsample_file = select_first([markDuplicatesAndToCram.cram_downsample_file, addReadGroupAndSort.bam_sorted_rg_file]),
      downsample_docker = downsample_docker,
  ...
  output {
    ...
    File mosaic_bam = addReadGroupAndSort.bam_sorted_rg_file
...
task combineAndRandomSort {
  ...
  String combined_fastq_1_name = "${sample_ID}_1.fastq"
  String combined_fastq_2_name = "${sample_ID}_2.fastq"
  String randomized_fastq_1_name = "${sample_ID}_1_randomized.fastq"
  String randomized_fastq_2_name = "${sample_ID}_2_randomized.fastq"

  output {
    File randomized_fastq_1_file = randomized_fastq_1_name
    File randomized_fastq_2_file = randomized_fastq_2_name
  }
...
task realign {
  ...
  String bam_downsample_name = basename(downsample_file_1, ".fastq") + ".bam"
